...
public abstract class Unit {
	 ...
	 * @param network is the {@link EnergyNetwork} it's in(adding to the energy network is done automatically)
	 */
	...
	/**
	 * This is the same as above, but here we have a player, so we can give items, etc.
	 * 
	...
	/**
	 * This method will setup fatal properties to the Unit
	 */
	private void init() {
	...
	public static List<Unit> getNeighbours(Location loc) {
		...
		if (target != null) units.add(target);
