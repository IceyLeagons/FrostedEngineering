...
import net.iceyleagons.frostedengineering.common.gui.CreativeMode;
...
public class CreativeCommand {
    @Cmd(cmd = "creative", args = "", argTypes = {}, help = "Sets your gamemode to Creative FE.", longhelp = "Sets your gamemode to Creative FE.", permission = net.iceyleagons.frostedengineering.common.other.permission.Permissions.COMMAND_GIVE, only = CommandOnly.PLAYER)
