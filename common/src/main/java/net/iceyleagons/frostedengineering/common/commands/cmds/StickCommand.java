...
public class StickCommand {
    ...
    @Cmd(cmd = "stick", args = "", argTypes = {}, help = "Gives you a stick.", longhelp = "Gives you a debug stick.", permission = net.iceyleagons.frostedengineering.common.other.permission.Permissions.COMMAND_DEBUG)
