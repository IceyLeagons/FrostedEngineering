...
import net.iceyleagons.frostedengineering.common.other.permission.PermissionManager;
...
public class CommandManager implements TabCompleter, CommandExecutor {
    ...
    @Cmd(cmd = "debug",
            ...
            permission = net.iceyleagons.frostedengineering.common.other.permission.Permissions.COMMAND_DEBUG)
        ...
        try {
            ...
            if (args.length == 0 || args[0].equalsIgnoreCase("help"))
                ...
                if (bestFit != null) {
                    ...
                    if (!PermissionManager.hasPermission(sender, bestFit.permission()))
    ...
    public static @interface Cmd {
         ...
         */
        net.iceyleagons.frostedengineering.common.other.permission.Permissions permission();
