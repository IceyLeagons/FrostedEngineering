...
public class DefaultConfig extends Config {
    ...
    public void init() {
        ...
        net.iceyleagons.frostedengineering.storage.yaml.Variables.AUTO_UPDATE = getConfig().getBoolean("auto-update");
        net.iceyleagons.frostedengineering.storage.yaml.Variables.LANG = getConfig().getString("lang");
        net.iceyleagons.frostedengineering.storage.yaml.Variables.ALLOW_CHEAT = getConfig().getBoolean("allow-cheating");
    }
