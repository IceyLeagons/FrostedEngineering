...
import net.iceyleagons.frostedengineering.common.vegetation.Tree;
...
public class BlockTestCommand {
    @Cmd(cmd = "blocktest", args = "", argTypes = {}, help = "Gives you a test block.", longhelp = "Gives you a test block.", permission = net.iceyleagons.frostedengineering.common.other.permission.Permissions.COMMAND_DEBUG)
