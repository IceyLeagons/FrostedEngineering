...
import net.iceyleagons.frostedengineering.common.generator.frosted.ChunkData.PointData;
...
public class FrostedDimension extends ChunkGenerator {
    ...
    public ChunkData generateChunkData(World world, Random random, int chunkX, int chunkZ,
        ...
        net.iceyleagons.frostedengineering.common.generator.frosted.ChunkData chunkBase = new net.iceyleagons.frostedengineering.common.generator.frosted.ChunkData(
                rx, rz, world.getSeed());
        PointData[] pointMap = chunkBase.generate();

        for (int i = 0; i < net.iceyleagons.frostedengineering.common.generator.frosted.ChunkData.typeSize; i++) {
            PointData noiseData = pointMap[i];

            x:
            for (int x = 0; x < net.iceyleagons.frostedengineering.common.generator.frosted.ChunkData.mapSize; x++) {
                z:
                for (int z = 0; z < net.iceyleagons.frostedengineering.common.generator.frosted.ChunkData.mapSize; z++) {
