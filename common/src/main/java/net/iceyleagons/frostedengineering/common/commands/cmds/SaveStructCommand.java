...
public class SaveStructCommand {
    ...
    @Cmd(cmd = "savestruct", args = "<name> <rarity> [monsters]", argTypes = {ArgString.class, ArgInteger.class,
            ArgString.class}, help = "Save the selected region as an festruct file.", longhelp = "Save the selected region with all it's required details in order to save it to an festurct file so we can use it in dungeons etc.", permission = net.iceyleagons.frostedengineering.common.other.permission.Permissions.COMMAND_SAVESTRUCT)
