...
import net.iceyleagons.frostedengineering.common.textures.interfaces.IWrapped;
        ...
        if (args[1] instanceof String) {
            ...
            try {
                if (b.getState() instanceof CreatureSpawner) {
                    ...
                    int id = (int) Reflections
                            .setAccessible(itemNBTTagCompound.getClass().getMethod("getInt", String.class))
                            .invoke(itemNBTTagCompound, "CustomItemId");
