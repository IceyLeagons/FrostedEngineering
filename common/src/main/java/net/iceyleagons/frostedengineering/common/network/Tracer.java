...
package net.iceyleagons.frostedengineering.common.network;
...
public class Tracer {
     ...
     * @throws UnsupportedUnitType if the provided {@link Network} doesn't support that {@link Unit} ex. you can only add an {@link net.iceyleagons.frostedengineering.common.network.energy.EnergyUnit} to an {@link net.iceyleagons.frostedengineering.network.energy.EnergyNetwork}
     */
